# Generated by Django 4.0.4 on 2022-07-17 21:30
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('token', models.UUIDField(blank=True, db_index=True, null=True, verbose_name='token')),
        ...
        migrations.AddField(
            model_name='topic',
            name='user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='apis.userinfo', verbose_name='用户'),
        ),
        migrations.AddField(
            model_name='recommend',
            name='news',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='apis.news', verbose_name='资讯'),
        ),
        migrations.AddField(
            model_name='recommend',
            name='user',
        ...
        migrations.AddField(
            model_name='news',
            name='topic',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='apis.topic', verbose_name='话题'),
        ),
        migrations.AddField(
            model_name='news',
            name='user',
        ...
        migrations.AddField(
            model_name='comment',
            name='reply',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='reply_list', to='apis.comment', verbose_name='回复'),
        ),
        migrations.AddField(
            model_name='comment',
            name='root',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='descendant', to='apis.comment', verbose_name='根评论'),
        ),
        migrations.AddField(
            model_name='comment',
            name='user',
